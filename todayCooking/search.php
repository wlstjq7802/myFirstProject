<?php
    ...
    if($searchCondition == "레시피명+재료"){
        $sql = "SELECT * FROM recipe WHERE ingredient LIKE '%$keyword%' OR recipeName LIKE '%$keyword%' ORDER BY recipeNum desc";
    } else if($searchCondition == "레시피명"){
        $sql = "SELECT * FROM recipe WHERE recipeName LIKE '%$keyword%' ORDER BY recipeNum desc";
    } else if($searchCondition == "재료"){
        $sql = "SELECT * FROM recipe WHERE ingredient LIKE '%$keyword%' ORDER BY recipeNum desc";
    }
